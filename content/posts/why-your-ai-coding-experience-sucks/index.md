...
In both cases, they're having tools dictated to them. I get to choose the ones that produce better outcomes.
...
Other times it comes down to "this is what the security team has told us we can use." And look, I get it. These aren't stupid decisions. Enterprise security teams have real concerns: code leaking to third-party APIs, IP exposure, compliance with data residency requirements, the audit trail question. When you've got 5,000 developers and a regulated industry, "just let everyone use whatever they want" isn't really an option.

The problem is that the tools which tick the security and procurement boxes aren't the ones producing the best results. There's a gap between what's approved and what's good, and right now that gap is massive.

## The tools work. The mandates don't.
